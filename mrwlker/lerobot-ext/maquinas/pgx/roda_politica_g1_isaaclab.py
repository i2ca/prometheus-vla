...
Diferença para o `maquinas/pgx/roda_pi05_g1_sim.py`: lá a política vinha de dado REAL e via render do
...
juntas e recorta os braços. Então basta preencher `motor_cmd[j].q`.
    ...
    python maquinas/pgx/roda_politica_g1_isaaclab.py                      # π0.5 de 30k passos
    python maquinas/pgx/roda_politica_g1_isaaclab.py --politica binabik-ai/act_PickPlaceRedBlock
"""
import os
