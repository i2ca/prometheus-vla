...
from tasks.common_scene.base_scene_cafe import TableCafeSceneCfg
...
@configclass
class ObjectTableSceneCfg(TableCafeSceneCfg):
...
@configclass
class CafeG129DEX3EnvCfg(ManagerBasedRLEnvCfg):
