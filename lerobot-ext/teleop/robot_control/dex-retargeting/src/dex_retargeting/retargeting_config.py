...
class RetargetingConfig:
    ...
    def from_dict(cls, cfg: Dict[str, Any], override: Optional[Dict] = None):
        ...
        if "finger_joint_names" in cfg:
            cfg["target_joint_names"] = cfg.pop("finger_joint_names")
        if "target_link_human_indices_joints" in cfg:
            cfg["target_link_human_indices_position"] = np.array(cfg.pop("target_link_human_indices_joints"))
        if "target_link_human_indices_pinch" in cfg:
            cfg.pop("target_link_human_indices_pinch")
