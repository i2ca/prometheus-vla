...
#
#   bash pgx/prepara_cena_caixa.sh            # cria ~/g1_mujoco_caixa
#   DESTINO=/outro/lugar bash pgx/prepara_cena_caixa.sh
set -euo pipefail
...
echo "== pronto. Use com:"
echo "   python pgx/roda_pi05_g1_sim.py --env-dir $DESTINO --passos 0 --tempo-real --v-web=8088"
